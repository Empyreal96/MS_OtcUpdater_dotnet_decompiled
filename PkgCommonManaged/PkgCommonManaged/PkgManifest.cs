...
namespace Microsoft.WindowsPhone.ImageUpdate.PkgCommon
{
	...
	{
		// Token: 0x0600011E RID: 286 RVA: 0x00006B70 File Offset: 0x00004D70
		public PkgManifest()
		{
		...
		// (get) Token: 0x0600011F RID: 287 RVA: 0x00006C1F File Offset: 0x00004E1F
		// (set) Token: 0x06000120 RID: 288 RVA: 0x00006C27 File Offset: 0x00004E27
		public ReleaseType ReleaseType { get; set; }

		// Token: 0x17000039 RID: 57
		// (get) Token: 0x06000121 RID: 289 RVA: 0x00006C30 File Offset: 0x00004E30
		// (set) Token: 0x06000122 RID: 290 RVA: 0x00006C38 File Offset: 0x00004E38
		public PackageStyle PackageStyle { get; set; }

		// Token: 0x1700003A RID: 58
		// (get) Token: 0x06000123 RID: 291 RVA: 0x00006C41 File Offset: 0x00004E41
		// (set) Token: 0x06000124 RID: 292 RVA: 0x00006C49 File Offset: 0x00004E49
		public OwnerType OwnerType { get; set; }

		// Token: 0x1700003B RID: 59
		// (get) Token: 0x06000125 RID: 293 RVA: 0x00006C52 File Offset: 0x00004E52
		// (set) Token: 0x06000126 RID: 294 RVA: 0x00006C5A File Offset: 0x00004E5A
		public BuildType BuildType { get; set; }

		// Token: 0x1700003C RID: 60
		// (get) Token: 0x06000127 RID: 295 RVA: 0x00006C63 File Offset: 0x00004E63
		// (set) Token: 0x06000128 RID: 296 RVA: 0x00006C6B File Offset: 0x00004E6B
		public CpuId CpuType { get; set; }

		// Token: 0x1700003D RID: 61
		// (get) Token: 0x06000129 RID: 297 RVA: 0x00006C74 File Offset: 0x00004E74
		// (set) Token: 0x0600012A RID: 298 RVA: 0x00006C7C File Offset: 0x00004E7C
		public string FeatureType { get; set; }

		// Token: 0x1700003E RID: 62
		// (get) Token: 0x0600012B RID: 299 RVA: 0x00006C85 File Offset: 0x00004E85
		// (set) Token: 0x0600012C RID: 300 RVA: 0x00006C8D File Offset: 0x00004E8D
		public string Culture { get; set; }

		// Token: 0x1700003F RID: 63
		// (get) Token: 0x0600012D RID: 301 RVA: 0x00006C96 File Offset: 0x00004E96
		// (set) Token: 0x0600012E RID: 302 RVA: 0x00006C9E File Offset: 0x00004E9E
		public string Resolution { get; set; }

		// Token: 0x17000040 RID: 64
		// (get) Token: 0x0600012F RID: 303 RVA: 0x00006CA7 File Offset: 0x00004EA7
		// (set) Token: 0x06000130 RID: 304 RVA: 0x00006CAF File Offset: 0x00004EAF
		public string PublicKey { get; set; }

		// Token: 0x17000041 RID: 65
		// (get) Token: 0x06000131 RID: 305 RVA: 0x00006CB8 File Offset: 0x00004EB8
		public string Name
		{
			get
			{
		...
		// (get) Token: 0x06000132 RID: 306 RVA: 0x00006D18 File Offset: 0x00004F18
		// (set) Token: 0x06000133 RID: 307 RVA: 0x00006D20 File Offset: 0x00004F20
		public string PackageName { get; set; }

		// Token: 0x17000043 RID: 67
		// (get) Token: 0x06000134 RID: 308 RVA: 0x00006D29 File Offset: 0x00004F29
		// (set) Token: 0x06000135 RID: 309 RVA: 0x00006D31 File Offset: 0x00004F31
		public string Owner { get; set; }

		// Token: 0x17000044 RID: 68
		// (get) Token: 0x06000136 RID: 310 RVA: 0x00006D3A File Offset: 0x00004F3A
		// (set) Token: 0x06000137 RID: 311 RVA: 0x00006D42 File Offset: 0x00004F42
		public string Component { get; set; }

		// Token: 0x17000045 RID: 69
		// (get) Token: 0x06000138 RID: 312 RVA: 0x00006D4B File Offset: 0x00004F4B
		// (set) Token: 0x06000139 RID: 313 RVA: 0x00006D53 File Offset: 0x00004F53
		public string SubComponent { get; set; }

		// Token: 0x17000046 RID: 70
		// (get) Token: 0x0600013A RID: 314 RVA: 0x00006D5C File Offset: 0x00004F5C
		// (set) Token: 0x0600013B RID: 315 RVA: 0x00006D64 File Offset: 0x00004F64
		public VersionInfo Version { get; set; }

		// Token: 0x17000047 RID: 71
		// (get) Token: 0x0600013C RID: 316 RVA: 0x00006D6D File Offset: 0x00004F6D
		// (set) Token: 0x0600013D RID: 317 RVA: 0x00006D75 File Offset: 0x00004F75
		public string Partition { get; set; }

		// Token: 0x17000048 RID: 72
		// (get) Token: 0x0600013E RID: 318 RVA: 0x00006D7E File Offset: 0x00004F7E
		// (set) Token: 0x0600013F RID: 319 RVA: 0x00006D86 File Offset: 0x00004F86
		public string Platform { get; set; }

		// Token: 0x17000049 RID: 73
		// (get) Token: 0x06000140 RID: 320 RVA: 0x00006D8F File Offset: 0x00004F8F
		// (set) Token: 0x06000141 RID: 321 RVA: 0x00006D97 File Offset: 0x00004F97
		public bool IsRemoval { get; set; }

		// Token: 0x1700004A RID: 74
		// (get) Token: 0x06000142 RID: 322 RVA: 0x00006DA0 File Offset: 0x00004FA0
		// (set) Token: 0x06000143 RID: 323 RVA: 0x00006DA8 File Offset: 0x00004FA8
		public string GroupingKey { get; set; }

		// Token: 0x1700004B RID: 75
		// (get) Token: 0x06000144 RID: 324 RVA: 0x00006DB1 File Offset: 0x00004FB1
		// (set) Token: 0x06000145 RID: 325 RVA: 0x00006DB9 File Offset: 0x00004FB9
		[SuppressMessage("Microsoft.Performance", "CA1819:PropertiesShouldNotReturnArrays")]
		public string[] TargetGroups { get; set; }

		// Token: 0x1700004C RID: 76
		// (get) Token: 0x06000146 RID: 326 RVA: 0x00006DC2 File Offset: 0x00004FC2
		// (set) Token: 0x06000147 RID: 327 RVA: 0x00006DCA File Offset: 0x00004FCA
		public string BuildString { get; set; }

		// Token: 0x1700004D RID: 77
		// (get) Token: 0x06000148 RID: 328 RVA: 0x00006DD3 File Offset: 0x00004FD3
		// (set) Token: 0x06000149 RID: 329 RVA: 0x00006DDB File Offset: 0x00004FDB
		public bool IsBinaryPartition { get; private set; }

		// Token: 0x1700004E RID: 78
		// (get) Token: 0x0600014A RID: 330 RVA: 0x00006DE4 File Offset: 0x00004FE4
		// (set) Token: 0x0600014B RID: 331 RVA: 0x00006DEC File Offset: 0x00004FEC
		public string Keyform { get; private set; }

		// Token: 0x1700004F RID: 79
		// (get) Token: 0x0600014C RID: 332 RVA: 0x00006DF5 File Offset: 0x00004FF5
		// (set) Token: 0x0600014D RID: 333 RVA: 0x00006E07 File Offset: 0x00005007
		[SuppressMessage("Microsoft.Performance", "CA1819:PropertiesShouldNotReturnArrays")]
		...
		// Token: 0x0600014E RID: 334 RVA: 0x00006E26 File Offset: 0x00005026
		public void BuildSourcePaths(string rootDir, BuildPathOption option)
		{
			this.BuildSourcePaths(rootDir, option, false);
		}

		// Token: 0x0600014F RID: 335 RVA: 0x00006E34 File Offset: 0x00005034
		...
		// Token: 0x06000150 RID: 336 RVA: 0x00006E94 File Offset: 0x00005094
		...
		// Token: 0x06000151 RID: 337 RVA: 0x00006F14 File Offset: 0x00005114
		...
		// Token: 0x06000152 RID: 338 RVA: 0x00006F70 File Offset: 0x00005170
		...
		// Token: 0x06000153 RID: 339 RVA: 0x00006FF4 File Offset: 0x000051F4
		...
		// Token: 0x06000154 RID: 340 RVA: 0x00007070 File Offset: 0x00005270
		...
		// Token: 0x06000155 RID: 341 RVA: 0x00007118 File Offset: 0x00005318
		...
		// Token: 0x06000156 RID: 342 RVA: 0x0000731C File Offset: 0x0000551C
		...
		// Token: 0x06000157 RID: 343 RVA: 0x000073FC File Offset: 0x000055FC
