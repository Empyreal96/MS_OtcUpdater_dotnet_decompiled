...
namespace Microsoft.WindowsPhone.ImageUpdate.PkgCommon
{
	...
	internal static class DiffPkgBuilder
	{
		...
		public static extern int CacheManifests(string[] manifests, [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPWStr)] [Out] string[] names, [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPWStr)] [Out] string[] versions, [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.U4)] [Out] uint[] sizes, [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.U8)] [Out] ulong[] offsets, uint count, string cacheFile, out string cmsVersion);
		...
		private class Pair<T1, T2>
		{
			...
			// (get) Token: 0x06000252 RID: 594 RVA: 0x0000ABE3 File Offset: 0x00008DE3
			// (set) Token: 0x06000253 RID: 595 RVA: 0x0000ABEB File Offset: 0x00008DEB
			public T1 First { get; set; }

			// Token: 0x170000A4 RID: 164
			// (get) Token: 0x06000254 RID: 596 RVA: 0x0000ABF4 File Offset: 0x00008DF4
			// (set) Token: 0x06000255 RID: 597 RVA: 0x0000ABFC File Offset: 0x00008DFC
			public T2 Second { get; set; }

			// Token: 0x06000256 RID: 598 RVA: 0x0000AC05 File Offset: 0x00008E05
